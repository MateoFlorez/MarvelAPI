...
export function Footer() {
  return (
    <div className="bg-stone-900 w-screen flex justify-between md:px-28 lg:px-40 sm:px-10 py-28 h-fit">
      ...
      <nav>
        <div className="space-y-7">
            <a href="https://www.marvel.com/insider?cid=Dcom_navigation_20200929_insider_footer" className="flex gap-5 items-center">
                <div className="w-16">
                ...
                <div className="text-white text-sm">
                    ...
                    <p className="text-sm">Get Rewarded for Being a Marvel Fan</p>
                </div>
            </a>
            <a href="https://www.marvel.com/unlimited?cid=dcom_navigation_20220712_unlimited_footer" className="flex gap-5 items-center">
                <div className="w-16">
      ...
      <nav className="box-border space-y-6">
        ...
        <ul className="flex space-x-8 w-52 flex-wrap">
