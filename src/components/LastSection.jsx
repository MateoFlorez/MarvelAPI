...
export function LastSection() {
    return (
        <div className="bg-black w-full flex justify-center text-white">
            <div className="flex flex-col box-border gap-2 cursor-pointer items-center md:flex-row 2xl:gap-40">
                <figure className="flex justify-center ">
                    <img src="https://terrigen-cdn-dev.marvel.com/content/prod/1x/01-mi-promo-april2020-featured-half-dsk-1140x680_4.jpg" alt="" className="h-full w-full"></img>
                </figure>
                <div className="flex flex-col justify-center items-center h-96 gap-2 pr-5">
